...
type ShopOrder struct {
	...
	ShopID      int       `gorm:"not null;index:idx_shop_orders_shop_id;index:idx_shop_orders_shop_status;index:idx_shop_orders_shop_created;uniqueIndex:uq_shop_orders_order_shop" json:"shopId"`
