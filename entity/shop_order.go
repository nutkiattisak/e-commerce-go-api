...
type ShopOrder struct {
	...
	ShopID      uint      `gorm:"not null;index:idx_shop_orders_shop_id;index:idx_shop_orders_shop_status;index:idx_shop_orders_shop_created;uniqueIndex:uq_shop_orders_order_shop" json:"shop_id"`
