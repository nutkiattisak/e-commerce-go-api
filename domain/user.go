...
type UserUsecase interface {
	...
	GetAddressByID(ctx context.Context, id uint32) (*entity.AddressResponse, error)
	...
	DeleteAddress(ctx context.Context, id uint32, userID uuid.UUID) error
}
...
type UserRepository interface {
	...
	GetAddressByID(ctx context.Context, id uint32) (*entity.Address, error)
